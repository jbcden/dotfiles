...
#		    PROMPT_COMMAND=/etc/sysconfig/bash-prompt-xterm
		    ...
		    PROMPT_COMMAND='echo -ne "\033]0;${USER}@${HOSTNAME%%.*}:${PWD/#$HOME/~}\007"'
	  	    #PROMPT_COMMAND='echo -ne "\e[0;36m[${USER}@${HOSTNAME%%.*}:${PWD/#$HOME/~}]$\e[m"'
		fi
		;;
	screen)
...
PS1="\e[0;36m[${USER}@${HOSTNAME%%.*}:$\w]$\e[m "
TERM="xterm-color"
export TZ="/usr/share/zoneinfo/America/New_York" # set correct time zone
## -----------------------
## -- 2) Set up aliases --
## -----------------------
...
alias mv="mv -i"
alias cp="cp -i"
set -o noclobber # prevents from overwriting the contents of a file
...
# an alias for checking memory usage of all subdirectories
# from startup class
alias mem='du --max-depth=1 -b | sort -k1 -rn'


# rvm configurations

[[ -s "/home/jchae/.rvm/scripts/rvm" ]] && source "/home/jchae/.rvm/scripts/rvm"
